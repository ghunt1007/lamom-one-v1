...
const DEFAULTS = {
  ...
  salesStaffChannel: {},
  // (v1.0.438) รายชื่อตำแหน่งงานมาตรฐาน — เดิมช่อง "ตำแหน่ง" ในหน้า User Management เป็นช่องพิมพ์เองล้วน
  // (ไม่มี dropdown มาตรฐาน) ทำให้พิมพ์ไม่ตรงกันได้ (เช่น "เซลส์"/"Sales"/"พนักงานขาย" ปนกัน) รายชื่อนี้เป็นชุด
  // เริ่มต้นที่ครอบคลุมตำแหน่งทั่วไปของธุรกิจโชว์รูม/ศูนย์บริการรถยนต์ EV — เจ้าของระบบแก้ไข/เพิ่ม/ลบเองได้
  // ทุกเมื่อที่หน้า Settings > Master Data (ใช้ MASTER_LISTS ด้านล่างเหมือน list อื่นๆทุกจุด ไม่ใช่ hardcode ตายตัว)
  positions: [
    'เซลส์', 'หัวหน้าเซลส์', 'ผู้จัดการฝ่ายขาย',
    'ช่างเทคนิค', 'ช่างเทคนิค EV', 'ที่ปรึกษาการบริการ', 'หัวหน้าช่าง', 'ผู้จัดการศูนย์บริการ',
    'เจ้าหน้าที่อะไหล่', 'หัวหน้าคลังอะไหล่',
    'เจ้าหน้าที่สต็อกรถ', 'พนักงานตรวจสภาพรถ (PDI)', 'พนักงานส่งมอบรถ',
    'เจ้าหน้าที่การเงิน', 'เจ้าหน้าที่สินเชื่อ/ไฟแนนซ์รถ', 'นักบัญชี', 'แคชเชียร์', 'ผู้จัดการฝ่ายการเงิน/บัญชี',
    'เจ้าหน้าที่ประกันภัย',
    'เจ้าหน้าที่การตลาด', 'แอดมินโซเชียลมีเดีย', 'ผู้จัดการฝ่ายการตลาด',
    'เจ้าหน้าที่บุคคล', 'ผู้จัดการฝ่ายบุคคล',
    'พนักงานต้อนรับ', 'เจ้าหน้าที่ธุรการ', 'รปภ.', 'แม่บ้าน',
    'ผู้จัดการสาขา', 'ผู้จัดการทั่วไป', 'กรรมการผู้จัดการ/เจ้าของ',
  ],
}
