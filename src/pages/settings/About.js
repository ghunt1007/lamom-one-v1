...
const CHANGELOG = [
  { ver:'1.0.68', date:'2026-06-29', label:'ล่าสุด', changes:['Cloud Deployment Stack — เปลี่ยน AI Engine จาก Claude API → Google Gemini 1.5 Flash (ฟรีตลอดไป 15 req/นาที), สร้าง Cloudflare R2 Upload Worker (workers/r2-upload.js) พร้อม storage.js utility สำหรับ file upload ทุกหน้า, เพิ่ม public/_redirects + public/_headers สำหรับ Cloudflare Pages SPA routing + security headers, wrangler.toml สำหรับ deploy R2 Worker, อัปเดต .env.example เพิ่ม VITE_GEMINI_API_KEY + VITE_R2_WORKER_URL'] },
