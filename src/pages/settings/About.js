...
const CHANGELOG = [
  { ver:'1.0.82', date:'2026-07-03', label:'ล่าสุด', changes:['🔒 ความปลอดภัย: แก้ Stored XSS ผ่านการ break-out จาก textarea ใน 7 หน้า — บันทึกประชุมทีม (/hr/meetings), Campaign note, LINE OA auto-reply, Compliance notes, ที่อยู่สาขา/บริษัท (/settings/branches, /settings/company), SMS OTP template: เดิมค่าที่บันทึกไว้ถูกใส่ในแท็ก textarea ตรงๆ โดยไม่ escape ถ้ามีข้อความ </textarea> ปนอยู่จะปิดแท็กก่อนกำหนดและรันโค้ด HTML/JS ที่ตามมาได้ทันทีที่เปิดฟอร์มแก้ไข (ไม่ต้องคลิกอะไรเพิ่ม) — เสี่ยงพนักงานสิทธิ์ต่ำโจมตีพนักงานสิทธิ์สูงที่เปิดดูบันทึกเดียวกัน ตอนนี้ escape ค่าทั้งหมดก่อน render แล้ว ทดสอบยิง payload </textarea><img onerror=...> จริงผ่าน UI ยืนยันว่าไม่ทำงานอีกต่อไป'] },
      ...
      <div style="max-width:720px;margin:0 auto">
        ...
        <div class="card" style="padding:28px;text-align:center;margin-bottom:14px;background:linear-gradient(135deg,var(--surface),var(--surface-2))">
          ...
          <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap">
            <span class="badge badge-primary">Version 1.0.82</span>
