...
const CHANGELOG = [
  { ver:'1.0.83', date:'2026-07-03', label:'ล่าสุด', changes:['ยอดจอง/ยอดขาย (/crm/bookings): เพิ่มฟิลด์ที่เทียบจาก LAMOM CRM V8 — เลขเครื่องยนต์ (แยกจากเลขมอเตอร์ สำหรับรถสันดาปอย่าง SUZUKI/NISSAN), เลขป้ายแดง (ชั่วคราว) และป้ายขาว (ทะเบียนถาวร) — บันทึก/แสดง/export ครบ', 'ใบถอนจอง: เพิ่มหน้าต่างกรอกเหตุผลถอนจอง + ยอดหักค่าดำเนินการ ก่อนพิมพ์เอกสารจริง (เดิมพิมพ์ทันทีแบบคืนเต็มจำนวนเสมอ ไม่มีจุดกรอกข้อมูลนี้เลย) เหตุผลที่กรอกจะถูกบันทึกกลับเข้าใบจองด้วย', 'เอกสารใบถอนจอง: เพิ่มช่องเซ็นชื่อที่ปรึกษาการขาย (เดิมมีแค่ผู้ถอนจองฝ่ายเดียว) + ตารางอนุมัติ 3 ระดับ (เจ้าหน้าที่การเงิน/ผู้จัดการฝ่ายขาย/ผู้อนุมัติ) พร้อมช่องความเห็น + ข้อความสงวนสิทธิ์คืนเงินมัดจำ — ทำให้เอกสารใช้เป็นแบบฟอร์มอนุมัติภายในได้จริงเหมือน V8'] },
      ...
      <div style="max-width:720px;margin:0 auto">
        ...
        <div class="card" style="padding:28px;text-align:center;margin-bottom:14px;background:linear-gradient(135deg,var(--surface),var(--surface-2))">
          ...
          <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap">
            <span class="badge badge-primary">Version 1.0.83</span>
