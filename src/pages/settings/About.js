...
const CHANGELOG = [
  { ver:'1.0.70', date:'2026-06-29', label:'ล่าสุด', changes:['First-user setup — เพิ่มฟอร์ม "สร้างบัญชีใหม่" บนหน้า Login สำหรับเจ้าของระบบ (owner คนแรก), Firebase Auth authorized domain: lamom-one-v1.pages.dev ✓, Firebase Storage ลบออก — ใช้ Cloudflare R2 แทน (Spark plan ฟรี)'] },
