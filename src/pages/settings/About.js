...
const CHANGELOG = [
  { ver:'1.0.80', date:'2026-07-03', label:'ล่าสุด', changes:['⚠️ Integrations (/integrations): เพิ่มคำเตือนในหน้าต่างตั้งค่าทุกช่องทาง (LINE, Facebook, TikTok, Google, DMS ภายนอก ฯลฯ) ว่าเป็น UI จำลองสำหรับสาธิตเท่านั้น ยังไม่เชื่อมต่อ API จริง และห้ามกรอก Secret/Token ของจริง — เดิมไม่มีคำเตือนก่อนกรอก มีความเสี่ยงที่พนักงานจะกรอกข้อมูลรับรองตัวจริงเข้าไปโดยเข้าใจผิดว่าเชื่อมต่อได้จริง แล้วถูกบันทึกแบบไม่เข้ารหัสในเบราว์เซอร์'] },
      ...
      <div style="max-width:720px;margin:0 auto">
        ...
        <div class="card" style="padding:28px;text-align:center;margin-bottom:14px;background:linear-gradient(135deg,var(--surface),var(--surface-2))">
          ...
          <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap">
            <span class="badge badge-primary">Version 1.0.80</span>
