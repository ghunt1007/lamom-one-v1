...
// เริ่มจากเมนูหลัก/ส่วนกลางเท่านั้น (Sidebar, Topbar, Login, Dashboard) ตามที่ตกลงไว้ — เนื้อหาในแต่ละหน้า
// (400+ หน้า) ยังเป็นภาษาไทยล้วน เป็นงานแยกที่ใหญ่กว่านี้มาก ไม่ได้ทำรอบนี้ คีย์ที่ไม่มีคำแปลจะ fallback
// กลับไปเป็นภาษาไทยเสมอ (ไม่มีวันโชว์ key เปล่าๆหรือ undefined ให้ผู้ใช้เห็น)
...
const DICT = {
  th: {
    ...
    collapseSidebar: 'ย่อ Sidebar', expandSidebar: 'ขยาย Sidebar',
