...
const SOURCES = [
  ...
  { col: 'leads', icon: '🎯', group: 'Lead', route: '/crm/leads',
    text: l => [l.firstName, l.lastName, l.phone, l.interestedModel, l.source, l.status].join(' '),
    title: l => [l.firstName, l.lastName].filter(Boolean).join(' '),
    sub: l => (l.interestedModel || '') + ' · ' + (l.status || '') + (l.source ? ' · ' + l.source : '') },
