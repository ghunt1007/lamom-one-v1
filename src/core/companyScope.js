...
// เห็นทุกบริษัทโดยไม่มีเงื่อนไข: owner/admin เสมอ, หรือถูกตั้ง flag groupWide เป็นรายบุคคล
// (สำหรับ HR/การตลาด/PDI/ตรวจสอบ/หัวหน้าบัญชีที่ต้องดูแลทุกบริษัทจริงตามผังองค์กร)
